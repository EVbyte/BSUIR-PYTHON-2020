from .ExternalMergeSort import ExternalSort
from .SingleTone import MetaSingleton, Check
from .Json import JSON, Company
...
class UnitTestJSON(unittest.TestCase):
    ...
    def setUp(self):
        self.json = JSON(Company("Zinin", "Egor", "Vaucheslavovish"))
        self.valid_json_string = '{"EployeeInfo": {"First_name": "Egor", "Second_name": "Zinin", "Patronymic_name": "Vaucheslavovish", "Married": false, "Kids": false, "Kids_Name": null, "Company_Name": "Gomel_milk", "Company_Phone": [(375, 29), 228, 14, 88]}}'
        self.obj = Company("Zinin", "Egor", "Vaucheslavovish")
